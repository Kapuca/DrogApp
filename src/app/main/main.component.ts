...
@Component({
  ...
  `,
  styles: [
    '#main { background-color: #262626; position: absolute; top: 64px; display: grid; grid-template-columns: 50vw 50vw; grid-template-rows: repeat(6, 33.33%); grid-gap: 0px; overflow-y: hidden; overflow-x: hidden; }',
