...
@Component({
  ...
  styles: [
    ...
    '.choice-bar-back { z-index: 2; position: fixed; top: 35vh; right: 0px; width: 35px; height: max-content; cursor: pointer; background: repeating-linear-gradient(45deg, #d40202bd, #d40202bd 10px, #ff0000a1 10px, #ff0000a1 20px); }',
